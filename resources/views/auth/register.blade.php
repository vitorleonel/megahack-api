            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-4"><small>{{ __('Cadastrar com') }}</small></div>
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>{{ __('Ou cadastre-se com credenciais') }}</small>
                        </div>
                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted">{{ __('Estou de acordo com os') }} <a href="#!">{{ __('Termos e Políticas de Privacidade') }}</a></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-block">{{ __('Criar coonta') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
